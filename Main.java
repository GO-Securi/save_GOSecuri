        ...
        BufferedWriter bw = new BufferedWriter(writer)){
            ...
            while (line_staff != null) {
                ...
                BufferedWriter bw_fiche_agent = new BufferedWriter(writer2)){
                    ...
                    //Header
                    bw_fiche_agent.write("<!DOCTYPE html><html><head><title>Agent: " +infos_agents.get(0) + " " + infos_agents.get(1)+ "</title><link href=\"..\\Style.css\" rel=\"stylesheet\" type=\"text/css\"></head><body><header><img class=\"logo\" src=\"..\\LogoGoSecuri.png\" alt=\"Logo de l'entreprise\"></header><div class=\"div_nomprenom\"><h1 class=\"nomprenom\">"+infos_agents.get(0) + " " + infos_agents.get(1)+ "</h1><br>(" + infos_agents.get(2) + ")" +"<img class=\"img_profil\" src=\"..\\" + line_staff + ".png\" alt=\"Photo de X\"><h2>Mon Equipement:</h2><ul class=\"liste\">");
